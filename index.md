...
address: "MLIB 045, CSU,Chico, or online"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
...
instructor: ["Robin Donatello (Chico)", "Essia Hamouda (CSUSB)", "Jing Guo (Chico)", "Kunal Marwaha (Berkeley)"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Faith Fatchen", "Derek Helms", "Blessing Nwogu"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
